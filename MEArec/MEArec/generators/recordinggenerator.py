...
class RecordingGenerator:
    ...
    def generate_recordings(self, tmp_mode=None, tmp_folder=None, verbose=None, n_jobs=0):
        ...
        #spiketrain info
        print('sup')
        print(spiketrains[0].annotations['fr'])
        print(spiketrains[1].annotations['fr'])
        print(spiketrains[2].annotations['fr']) #fr, cell_type
        print('sup')
        """
        ...
        if only_noise:
            ...
            if tempgen is not None:
                ...
                #my change here !!!
                #hopefully this avoid the reordering of the cell and associates the rates correctly
                reordered_idx_cells = range(len(locs))
                selected_cat = bin_cat
                #my change here !!!!
